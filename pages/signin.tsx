  ...
  return (
    <>
      ...
      <div className="h-screen flex flex-col items-center bg-white dark:bg-primaryBgDark">
        <form
          className="p-4 pb-12 px-5 flex flex-col  max-w-sm  w-[90%]   text-gray-500 rounded-lg overflow-hidden bg-primaryBg dark:bg-dashboardBgDark"
          style={{
            boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px",
          }}
          onSubmit={(e) => handleSubmit(e)}
        >
          <h3 className="text-2xl text-black pt-4 pb-1 dark:text-white">
            SignIn
          </h3>
          ...
          {error && (
            <p className="py-2 text-red-600">Invalid Login credentials</p>
          )}
